...
All the environments are registered in the `Forte_Isaac` extension. They start
...
import Forte_Isaac.tasks  # noqa: F401


def main():
    """Print all environments registered in `Forte_Isaac` extension."""
