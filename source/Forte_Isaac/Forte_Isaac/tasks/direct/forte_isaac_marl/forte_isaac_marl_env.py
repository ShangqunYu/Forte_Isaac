...
from .forte_isaac_marl_env_cfg import ForteIsaacMarlEnvCfg


class ForteIsaacMarlEnv(DirectMARLEnv):
    cfg: ForteIsaacMarlEnvCfg

    def __init__(self, cfg: ForteIsaacMarlEnvCfg, render_mode: str | None = None, **kwargs):
